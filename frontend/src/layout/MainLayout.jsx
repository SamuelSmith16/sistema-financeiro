      ...
      <div className="flex flex-1 relative">
        ...
        >
          ...
          <nav className="flex flex-col gap-1 p-4">
            <NavItem to="/" icon={<HomeIcon className="w-5 h-5" />} label="Dashboard" active={location.pathname === "/"} />
            <NavItem to="/lancamentos" icon={<ClipboardDocumentListIcon className="w-5 h-5" />} label="Lançamentos" active={location.pathname === "/lancamentos"} />
            <NavItem to="/cartoes" icon={<CreditCardIcon className="w-5 h-5" />} label="Cartões" active={location.pathname === "/cartoes"} />
            <NavItem to="/simulacoes" icon={<CalculatorIcon className="w-5 h-5" />} label="Simulações" active={location.pathname === "/simulacoes"} />
          </nav>
        </aside>
